...
export class CreateClassroomDto {
  ...
  @ApiPropertyOptional({
    example: true,
    description:
      'Tự động tính toán thời gian dựa trên số buổi học của khóa học',
  })
  @IsOptional()
  @IsBoolean()
...
export class SystemScheduleQueryDto {
  ...
  @ApiPropertyOptional({
    description:
      'Number of days to include. Defaults to 7 (1 week). Max 31 for monthly view.',
    example: 7,
  })
  @IsOptional()
  @IsInt()
  ...
  @ValidateIf(
    (o) =>
      o.teacherId !== undefined && o.teacherId !== null && o.teacherId !== '',
  )
  @IsUUID('4')
  teacherId?: string;
