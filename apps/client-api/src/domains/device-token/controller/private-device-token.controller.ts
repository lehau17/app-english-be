...
import { CreateDeviceTokenDto, FilterDeviceTokenRequestDto, UpdateDeviceTokenDto } from '../dto/device-token.dto';
...
export class PrivateDeviceTokenController {
    ...
    list(@Query() query: FilterDeviceTokenRequestDto): Promise<PageResponseDto<DeviceToken>> {
