...
export class VocabularyRepository {
    ...
    async createList(data: Prisma.VocabularyListCreateInput): Promise<VocabularyList> {
    ...
    async createUnit(data: Prisma.VocabularyUnitCreateInput): Promise<VocabularyUnit> {
    ...
    async createTerm(data: Prisma.VocabularyTermCreateInput): Promise<VocabularyTerm> {
    ...
    async findDueCards(userId: string, params?: {
        listId?: string;
        limit?: number;
    }) {
    ...
    async findNewCards(userId: string, params?: {
        listId?: string;
        unitId?: string;
        limit?: number;
    }) {
    ...
    async findUserReviewSessions(userId: string, params?: {
        listId?: string;
        limit?: number;
    }) {
