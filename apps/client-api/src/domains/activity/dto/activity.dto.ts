...
export class CreateActivityDto {
  ...
  @ApiProperty({
    type: 'object',
    description: 'Typed content based on activity type',
  })
  @IsObject()
  ...
  @ApiPropertyOptional({
    type: [String],
    description: 'Hints (plain text list).',
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
...
export function getDefaultContentByType(type: ActivityType): ActivityContent {
  switch (type) {
    ...
    case ActivityType.listening:
      return { audioUrl: '', instructions: '', questions: [] };
