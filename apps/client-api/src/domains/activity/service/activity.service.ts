...
import { CreateActivityDto, FilterActivityRequestDto, UpdateActivityDto } from '../dto/activity.dto';
...
export class ActivityService {
    ...
    async list(params: FilterActivityRequestDto): Promise<PageResponseDto<Activity>> {
