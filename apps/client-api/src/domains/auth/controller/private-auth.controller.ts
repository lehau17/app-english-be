...
export class PrivateAuthController {
    ...
    @ApiBadRequestResponse({ description: 'Current password invalid or payload invalid' })
    @ApiUnauthorizedResponse({ description: 'Unauthorized' })
    @ResponseMessage('Password changed successfully')
    async changePassword(@PayloadToken() tokenPayload: JwtPayload, @Body() dto: ChangePasswordDto) {
