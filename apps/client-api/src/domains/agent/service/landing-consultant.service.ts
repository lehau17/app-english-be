...
`,
      ...
      this.logger.error(
        'Failed to initialize Landing Consultant Agent:',
        error,
      );
      throw error;
    }
    ...
    return new DynamicStructuredTool({
      ...
      schema: z.object({
        level: z
          .string()
          .optional()
          .describe('Lọc theo trình độ (beginner, intermediate, advanced)'),
        ...
        return JSON.stringify({
          ...
          classrooms: classrooms.map((classroom) => {
            ...
            return {
              ...
              availableSlots:
                (classroom.maxStudents || 0) - classroom.students.length,
              price: course.price || 0,
