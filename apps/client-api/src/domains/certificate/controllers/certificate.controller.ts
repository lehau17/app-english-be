import { JwtPayload, PayloadToken, ResponseMessage, Roles, RolesGuard } from '@app/shared';
import {
  Body,
  Controller,
  Get,
...
export class CertificateController {
    ...
    @ApiOperation({ summary: 'Verify certificate by certificate number (Public)' })
    @ApiResponse({ status: 200, description: 'Certificate verified' })
    @ResponseMessage('Certificate verified successfully')
    async verifyCertificateByNumber(@Param('certificateNumber') certificateNumber: string) {
