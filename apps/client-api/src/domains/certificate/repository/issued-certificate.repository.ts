...
export class IssuedCertificateRepository {
    ...
    async create(data: Prisma.IssuedCertificateCreateInput): Promise<IssuedCertificate> {
    ...
    async findByCertificateNumber(certificateNumber: string): Promise<IssuedCertificate | null> {
        return this.prisma.issuedCertificate.findUnique({
    ...
    async findByVerificationCode(verificationCode: string): Promise<IssuedCertificate | null> {
        return this.prisma.issuedCertificate.findUnique({
