...
describe('PodcastCommentService', () => {
  ...
  describe('createComment', () => {
    ...
    it('should create a reply comment successfully', async () => {
      ...
      const createReplyDto: CreatePodcastCommentDto = {
        ...createCommentDto,
        parentId,
      };
      ...
      expect(prisma.podcastComment.findUnique).toHaveBeenCalledWith({
        where: { id: parentId },
      });
      expect(prisma.podcastComment.create).toHaveBeenCalledWith({
        data: {
    ...
    it('should throw NotFoundException if podcast not found', async () => {
      ...
      ).rejects.toThrow(new NotFoundException('Podcast not found'));
    });
    ...
    it('should throw BadRequestException if parent comment is invalid', async () => {
      ...
      await expect(
        service.createComment(userId, createReplyDto),
      ).rejects.toThrow(new BadRequestException('Invalid parent comment'));
    });
  });
  ...
  describe('deleteComment', () => {
    ...
    it("should throw ForbiddenException if user tries to delete another user\\'s comment", async () => {
      ...
      prisma.podcastComment.findUnique.mockResolvedValue(
        anotherUserComment as any,
      );
  ...
  describe('getCommentsByPodcast', () => {
    ...
    it('should return paginated comments', async () => {
      ...
      expect(prisma.podcastComment.findMany).toHaveBeenCalledWith(
  ...
  describe('updateComment', () => {
    ...
    it('should throw NotFoundException if comment not found', async () => {
      ...
      await expect(
        service.updateComment(userId, commentId, updateCommentDto),
