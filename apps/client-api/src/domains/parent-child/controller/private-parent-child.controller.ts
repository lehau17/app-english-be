...
export class PrivateParentChildController {
    ...
    @ApiOperation({
        ...
        description: 'Admin hoặc Teacher có thể xem danh sách các yêu cầu liên kết đang chờ duyệt',
    })
    ...
    @ApiOperation({
        ...
        description: 'Admin hoặc Teacher duyệt yêu cầu liên kết giữa parent và student',
    })
    ...
    @ApiOperation({
        ...
        description: 'Admin hoặc Teacher từ chối yêu cầu liên kết giữa parent và student',
    })
