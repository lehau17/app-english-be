...
export class PrivateParentChildController {
    ...
    findById(@Param('parentId', new ParseUUIDPipe()) parentId: string, @Param('childId', new ParseUUIDPipe()) childId: string) {
    ...
    delete(@Param('parentId', new ParseUUIDPipe()) parentId: string, @Param('childId', new ParseUUIDPipe()) childId: string) {
    ...
    list(@Query() query: FilterParentChildRequestDto): Promise<PageResponseDto<ParentChild>> {
