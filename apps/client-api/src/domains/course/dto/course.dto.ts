...
export class ImportCoursesDto {
  ...
  @ApiPropertyOptional({
    example: true,
    description: 'Chỉ parse & trả preview, không ghi DB',
  })
  @IsOptional()
  @IsBoolean()
  dryRun?: boolean;
  ...
  @ApiPropertyOptional({
    example: true,
    description: 'Nếu Title trùng thì update (upsert theo title)',
  })
  @IsOptional()
  @IsBoolean()
  upsert?: boolean;
  ...
  @ApiPropertyOptional({
    example: false,
    description: 'Publish ngay sau khi import',
  })
  @IsOptional()
  @IsBoolean()
  publish?: boolean;
  ...
  @ApiPropertyOptional({
    ...
    description: 'Instructor ID (sẽ được lấy từ JWT token nếu không cung cấp)',
  })
  @IsOptional()
  @IsUUID()
  ...
  @ApiPropertyOptional({
    example: 'title',
    description:
      'Cách xác định course để upsert: "title" (mặc định) hoặc "orderNo"',
  })
  @IsOptional()
  @IsString()
  matchBy?: 'title' | 'orderNo';
}
