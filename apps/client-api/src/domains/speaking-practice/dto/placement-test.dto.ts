...
export const PLACEMENT_TEST_ITEMS: PlacementTestItem[] = [
  ...
  },
  {
    ...
    type: 'phrase',
    text: 'fresh fish',
    targetPhonemes: ['f', 'r', 'e', 'ʃ', 'ɪ'],
    difficulty: 2,
  },
  {
    id: 'pt-11',
    type: 'sentence',
    text: 'The thin man thinks.',
    targetPhonemes: ['ð', 'θ', 'ɪ', 'n', 'm', 'æ', 'ŋ', 'k', 's'],
    difficulty: 3,
  },
  {
    id: 'pt-12',
  ...
  },
  {
    ...
    targetPhonemes: ['r', 'e', 'd', 'l', 'ɒ', 'r', 'ɪ', 'j', 'e', 'l', 'əʊ'],
    difficulty: 3,
  },
  {
    id: 'pt-14',
    type: 'sentence',
    text: 'I think the weather is nice.',
    targetPhonemes: [
      'aɪ',
      'θ',
      'ɪ',
  ...
  },
  {
    id: 'pt-15',
    type: 'sentence',
    text: 'Peter picked a pepper.',
    targetPhonemes: ['p', 'iː', 't', 'ə', 'ɪ', 'k', 't', 'e', 'p', 'ə'],
    difficulty: 3,
  },
];
